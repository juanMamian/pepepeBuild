interface InputGenerarExpresion {
    valor: number,
    numero1: ExpresionNumerica,
    numero2: ExpresionNumerica,
...
class ExpresionNumerica {
    ...
    reexpresionar(this: ExpresionNumerica, reexpresiones: number, opcionesGenerarExpresion: opcionesGeneracionExpresion) {
        ...
        if(reexpresiones < 0)reexpresiones=0;
...
class ExpresionNumericaBuilder {
    ...
    static generarExpresionNumericaRecursiva(datosExpresion: InputGenerarExpresion, recursiones: number, opciones: opcionesGeneracionExpresion): ExpresionNumerica {
