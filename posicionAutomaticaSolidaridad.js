...
exports.posicionAutomaticaSolidaridad = void 0;
...
function posicionAutomaticaSolidaridad() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            var todosObjetivos = yield Objetivo_1.ModeloObjetivo.find({}).exec();
            var todosTrabajos = yield Trabajo_1.ModeloTrabajo.find({}).exec();
        ...
        while (true) {
            ...
            try {
                configuracion = yield ConfiguracionAtlas_1.ModeloConfiguracionAtlas.findOne({ nombre: "solidaridad" }).exec();
            }
            catch (error) {
...
exports.posicionAutomaticaSolidaridad = posicionAutomaticaSolidaridad;
